...
public class EntradaTest extends TestCase {
	...
	public void setUp(){
		entrada= new EntradaConDireccion(1,2,2,new Vector(2,1),45);
	}
	...
	public void testEntradaPunto20PerteneceAEntrada() {
		EntradaConDireccion entrada2 = new EntradaConDireccion(1,2,3,new Vector(2,1),45);
	...
	public void testEntradaDireccion10Correcta() {
		EntradaConDireccion entrada2 = new EntradaConDireccion(0,0,3,new Vector(1,0),45);
